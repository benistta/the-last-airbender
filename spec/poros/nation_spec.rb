...
RSpec.describe Nation do
  it 'exists' do
    data = {:_id=>"5cf5679a915ecad153ab68fd", :allies=>["Ozai"], :enemies=>["Earth Kingdom"], :name=>"Chan (Fire Nation admiral)", :affiliation=>"Fire Nation Navy"},
           ...
           {:_id=>"5cf5679a915ecad153ab6929",
            ...
            :affiliation=>"Fire Nation school"},
           {:_id=>"5cf5679a915ecad153ab692a",
            :allies=>["Aang"],
            :enemies=>["Combustion Man"],
           ...
           {:_id=>"5cf5679a915ecad153ab69c7",
            :allies=>["Ukano"],
            :enemies=>["Azula", "Ukano", "Team Avatar "],
           ...
           {:_id=>"5cf5679a915ecad153ab6a8b",
            ...
            :affiliation=>" Boiling Rock Capital City Prison (formerly)[2] Fire Nation"},
           {:_id=>"5cf5679a915ecad153ab69da",
            :allies=>["Ming-Ming"],
            :enemies=>[],
           ...
           {:_id=>"5cf5679a915ecad153ab69df",
            :allies=>["Mrs. Morishita", ""],
            :enemies=>["Earth King"],
            :photoUrl=>"https://vignette.wikia.nocookie.net/avatar/images/0/04/Morishita.png/revision/latest?cb=20130115075424",
            :name=>"Morishita",
            :affiliation=>" Fire Nation Fire Nation colonies Yu Dao"},
           {:_id=>"5cf5679a915ecad153ab6a4f",
            :allies=>["Fire Nation", ""],
            :enemies=>["Roku", ""],
      ...
      nation = Nation.new(data)
      expect(nation).to be_a(Nation)
      expect(nation.members).to eq(97)
      # require "pry"; binding.pry
  end
end
